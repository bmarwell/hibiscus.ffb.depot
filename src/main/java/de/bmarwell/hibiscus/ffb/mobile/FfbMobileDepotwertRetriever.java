package de.bmarwell.hibiscus.ffb.mobile;
...
public class FfbMobileDepotwertRetriever {
  ...
  public void synchronize() {
    try {
      ...
      Logger.error("Malformed URL in FFB-Project: [" + mue.getMessage() + "]. Please send this to developer.", mue);
      ...
      Logger.error("Could not read from: [" + ioEx.getMessage() + "]. Please try again or send this to developer.");
      throw new RuntimeException(
